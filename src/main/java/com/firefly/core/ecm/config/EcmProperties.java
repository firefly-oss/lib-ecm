...
public class EcmProperties {
     ...
     * for handling ECM operations. Common values include:</p>
     * <ul>
     *   <li>"s3" - Amazon S3 adapter</li>
     *   <li>"azure-blob" - Azure Blob Storage adapter</li>
     *   <li>"minio" - MinIO adapter</li>
     *   <li>"alfresco" - Alfresco adapter</li>
     *   <li>"docusign" - DocuSign eSignature adapter</li>
     * </ul>
     *
